...
const Section1 = () => {
  ...
  return (
    <div className=" rounded-bl-[140px] rounded-br-[140px] bg-[#f2fafa]">
      <main className="container  mx-auto px-4 py-16 md:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-xl">
              ...
              <div className="relative flex-1">
                <input
                  ...
                  className="w-full px-4 py-3 pr-[45px] border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <button
          ...
          <div className="relative">
            ...
            <div className="absolute  bottom-[13px] left-[90px]">
                <img className="rounded-word" src={rounded}/>
            </div>
