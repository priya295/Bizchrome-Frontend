      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-2 items-center">
          ...
          <ul className="flex flex-wrap justify-center gap-6 md:gap-8 text-sm">
            {[
              ...
              <li key={title}>
                <a href={url} className="text-gray-600 hover:text-blue-600 transition-colors">
                  {title}
                </a>
              </li>
            ))}
        ...
        <div className="mt-12 ">
          ...
          <div className="flex items-center space-x-3 text-gray-600">
            ...
            <a href="mailto:Contact@Bizchrome.com" className="hover:text-blue-600 transition-colors">
