...
const Section1 = () => {
  return (
    <div className="relative min-h-[400px] w-full flex flex-col items-center justify-center text-white">
      ...
      <div className="absolute inset-0 custom-bg bg-cover bg-center">
        <div className="absolute"></div>
      </div>

      {/* Content */}
      <div className="relative z-10 text-center space-y-6">
        <h1 className="text-5xl md:text-7xl attractive-font font-bold text-white">
          ABOUT US
        </h1>
        ...
        <nav className="flex justify-center items-center space-x-2 text-sm md:text-base">
          ...
          <a href="/pages" className="hover:text-blue-600 transition-colors">
            PAGES
          </a>
          <span className="text-black">›</span>
